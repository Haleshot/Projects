...
from Next_Page import Ui_Background
...
# TO DO:
"""
1. The Background.hide() is not working for Next_Page. The Image_Processing Screen opens but Next_Page is running in the background.
2. Do the above for every screen transition after the First Window.
...
class Ui_bgWidget(QDialog, object):
...
"padding-right:20px;")
        ...
        self.Date_Time_Log.setGeometry(QtCore.QRect(750, 10, 500, 61))
        ...
        self.Next_Page.setGeometry(QtCore.QRect(750, 680, 271, 71))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.Next_Page.setFont(font)
        self.Next_Page.setStyleSheet("background-color: rgb(0, 255, 127);")
        ...
        self.Error_Message.setGeometry(QRect(375, 690, 550, 41))
    ...
    def retranslateUi(self, bgWidget):
        ...
        self.Next_Page.setText(_translate("bgWidget", "Next Page"))
        ...
        # Helps us in detecting a particular registered person by Facial Detection.
        # It refers to the Images in the Dataset -> TrainingImage folder.
        self.Next_Page.clicked.connect(self.Image_Page)
    ...
    def Image_Page(self):
        ...
        bgWidget.hide() # Hides the MainWindow and moves over to the Next Page window (so we won't have multiple windows open - saves memory as well).
        self.window.show()


        # If we were using the LoadUI functionm the following lines could've been used.
        # next = Image_Processing_Page()
...
# class Image_Processing_Page(QDialog):
    
#     def __init__(self):
#         super(Image_Processing_Page, self).__init__()
#         loadUi(r"All_Project_Files\Final_Project_Files\ui_Next_Page.py", self)
